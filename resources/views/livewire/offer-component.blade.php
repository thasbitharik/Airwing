                ...
                <div class="modal-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="promo_code" placeholder="Promo Code"
                                >
                            @error('promo_code')
                            <span class="text-danger text-sm">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="dis_per" placeholder="Discount"
                                >
                            @error('dis_per')
                            <span class="text-danger text-sm">{{ $message }}</span>
                            @enderror
