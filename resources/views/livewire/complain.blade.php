...
<div>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-info text-white-all">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Customer Complain</li>
        </ol>
    </nav>
                ...
                <div class="modal-body">
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" wire:model="seenby" placeholder="Seen By"
                                >
                            @error('seenby')
